...
import { Moon, Sun, Search, MapPin, Briefcase, DollarSign, Building2, Clock, Filter, ChevronRight, X } from 'lucide-react';
    ...
    try {
      const queryParams = new URLSearchParams({
        ...
        ...(filters.salaryRange && {
          ...
          ...(filters.salaryRange === '50k-100k' && { minSalary: 50000, maxSalary: 100000 }),
          ...(filters.salaryRange === '100k+' && { minSalary: 100000 })
        })
      });

      const response = await fetch(`${process.env.NEXT_PUBLIC_BackendURL}/jobs?${queryParams}`);
