...
function RoleHandler({ setFormData }) {
  ...
  useEffect(() => {
    if (role) {
      ...
      // Normalize role value - simplify to either "candidate" or "org"
      const normalizedRole = ["hr", "hrmanager", "hrManager"].includes(
        role.toLowerCase()
      )
        ? "org"
        : role.toLowerCase();
        ...
        <div className="text-center flex flex-col items-center">
          <div className="mb-8 max-w-md">
            ...
            <p className="text-md-on-primary opacity-80 text-lg">
              Create an account to unlock personalized job matching and career
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-md-surface-container p-8 rounded-3xl shadow-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Replace the existing selection with the simplified UI */}
              <div className="mt-5">
                ...
                <div className="relative">
                  ...
                  <div className="flex w-full rounded-full bg-md-surface-container-high mb-3 p-1 relative">
                    ...
                    <button
                      type="button"
                      onClick={() => handleUserTypeSelect("org")}
                      className={`flex-1 relative py-2 rounded-full text-center transition-all duration-300 z-10 ${
                        formData.userType === "org"
                          ? "text-md-on-primary"
                          : "text-md-on-surface"
                      }`}
                    >
                  ...
                  {/* Content Container with Option Description */}
                  <div className="p-4 rounded-2xl bg-md-primary-container h-[78px] flex items-center">
                    {formData.userType === "candidate" ? (
                      <div className="flex items-center">
                        ...
                        <div>
                          <p className="font-medium text-md-on-primary-container">
                            Candidate
                          </p>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 flex w-full justify-center space-x-4">
              <a
                href={`${process.env.NEXT_PUBLIC_API_URL}/auth/google?userType=${formData.userType}&action=register`}
              ...
              <a
                href={`${process.env.NEXT_PUBLIC_API_URL}/auth/microsoft?userType=${formData.userType}&action=register`}
                className="flex items-center justify-center py-2 px-8 bg-md-surface-container rounded-3xl hover:bg-md-surface-container-high transition-colors duration-200"
              >
                <svg
                  className="w-6 h-6"
              ...
              <a
                href={`${process.env.NEXT_PUBLIC_API_URL}/auth/linkedin?userType=${formData.userType}&action=register`}
                className="flex items-center justify-center py-2 px-8 bg-md-surface-container rounded-3xl hover:bg-md-surface-container-high transition-colors duration-200"
              >
                <svg
                  className="w-6 h-6"
