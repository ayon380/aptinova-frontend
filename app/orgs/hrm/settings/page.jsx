...
const OrganizationSettings = () => {
  ...
  return (
    <div className="flex flex-col w-screen p-5 h-full md:w-full  ">
      {refreshing && (
      ...
      <div className="flex flex-1 pt-2 md:pt-5 md:rounded-tl-3xl   overflow-y-scroll scrollbar-hide h-full">
        {/* Added min-w-0 */}
