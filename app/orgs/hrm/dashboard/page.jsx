...
export default function HRMDashboard() {
  ...
  return (
    <div className="bg-md-surface-container rounded-tl-3xl overflow-y-auto min-h-screen p-4 md:p-6">
      {dashboardData && (
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <motion.div
              ...
              className="bg-md-surface-container-highest p-5 rounded-3xl "
            >
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              ...
                              <div>
                                <h3 className="text-md-on-surface font-medium truncate max-w-[200px]">
                  ...
                  {dashboardData.recentApplicants.map((applicant, index) => (
                    ...
                    >
                      <td className="py-4 px-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10 bg-md-primary-container rounded-full flex items-center justify-center text-md-on-primary-container font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <motion.div
              ...
              className="bg-md-primary-container p-5 rounded-3xl shadow-sm flex flex-col justify-between mb-10"
            >
              <div>
            ...
            <motion.div
              ...
              className="bg-md-secondary-container p-5 rounded-3xl shadow-sm flex flex-col justify-between min-h-[180px]"
            >
              <div>
            ...
            <motion.div
              ...
              className="bg-md-tertiary-container p-5 rounded-3xl shadow-sm flex flex-col justify-between min-h-[180px]"
            >
              <div>
