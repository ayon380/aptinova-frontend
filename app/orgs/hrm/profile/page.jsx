                    ...
                    {passkeys.length === 0 ? (
                      ...
                      <ul className="space-y-4">
                        {passkeys.map((passkey) => (
                          <li
                            key={passkey.cred_id}
                            className="flex flex-col p-4 bg-md-surface-container-high rounded-3xl border border-md-outline"
                          >
                            <div className="flex items-start justify-between w-full">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                  <div className="flex items-center flex-wrap gap-x-2">
                                    <span className="font-medium text-md-on-surface truncate max-w-[140px] sm:max-w-full">
                                      {passkey.deviceName}
                                    </span>
                                  ...
                                  <div className="text-sm text-md-on-surface-variant truncate">
                              ...
                              <button
                                ...
                                className="p-2.5 ml-2 text-md-error bg-md-surface-container rounded-full hover:bg-md-error-container hover:text-md-on-error-container transition-colors"
                            ...
                            <div className="text-sm text-md-on-surface-variant mt-2 ml-10">
